                                    ...
                                    <tbody>
                                        <c:forEach items="${contenidos}" var="contenido">
                                            <tr>
                                                ...
                                                <td><a href="ServletCrearActividades?idContenido=${contenido.idContenido}&accion=verContenido"><button class="btn btn-info"><span class="glyphicon glyphicon-eye-open"></span> Crear Actividad</button></a></td>
                                            </tr>
                                        </c:forEach>    
                                    </tbody>
                                </table>
