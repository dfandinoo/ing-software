    ...
    <body style="background-color: #FFF8DC;">
        <div class="container-fluid">
           ...
           <div class="row" style="margin-top: 15px;">
                ...
                <div class="col-md-6">
                    <form action="ServletQuejasYReclamos">
                        <div class="alert alert-success " role="alert">${mensaje}</div>
                        <div class="form-group">
                            <legend>Correo:</legend>
                            <input type="text" name="correo" value="${correo}"  class="form-control" placeholder="Ingrese la direccion de correo a donde recibira respuesta" required>
                        </div>
                        <div class="form-group">
                        ...
                        <div style="margin-top: 20px;">
                            <button class="btn btn-success"  name="accion" value="enviarQueja"><span class="glyphicon glyphicon-ok"></span> Enviar </button>
